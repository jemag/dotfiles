...
vim.keymap.set("n", "<cr>s", '"+<cmd>lua require("substitute").operator()<cr>', { noremap = true, desc = "Substitute with +reg" })
...
vim.keymap.set("x", "<cr>s", '"+<cmd>lua require("substitute").visual()<cr>', { noremap = true, desc = "Substitute with +reg" })
